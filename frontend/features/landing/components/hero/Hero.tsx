...
export function Hero() {
  return (
    <section className="relative flex min-h-dvh items-center justify-center overflow-hidden px-6 pt-16 pb-20">
      {/* Ambient blobs */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/3 -translate-x-1/2 -translate-y-1/2 size-[600px] rounded-full bg-primary/[0.04] blur-[120px]" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center space-y-8">
        ...
        >
          ...
          <p className="mx-auto max-w-[42rem] text-pretty text-lg sm:text-xl text-muted-foreground leading-relaxed">
        ...
        >
          <Link
            href="/create"
            className="group flex items-center gap-3 rounded-2xl bg-primary px-6 py-3.5 text-base font-semibold text-primary-foreground hover:opacity-90 transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] active:scale-[0.98] active:translate-y-px"
          >
          ...
          <Link
            href="/polls"
            className="flex items-center gap-2 rounded-2xl border border-border bg-secondary/30 px-6 py-3.5 text-base font-medium text-muted-foreground hover:bg-secondary/50 hover:text-foreground transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] active:translate-y-px active:scale-[0.99]"
          >
            View dashboard
